...
comp: incbin "image.bin" ;Include the compressed data (it will go right after the original MBR)
...
times 20480 - ($ - $$) db 0 ;Fill the rest of the disk image so it reaches 20480 bytes